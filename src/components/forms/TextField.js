...
const TextFieldInput = styled.input`
  ...
  & + ${TextFieldLabel} {
    transform: ${props => (props.error && !props.value ? 'translateY(-10%)' : '')};
  }

  &:focus {
    outline: none;
     border-color: ${props => (!props.error ? props.theme.colors.input.border : props.theme.colors.alizarinCrimson)};
    & + ${TextFieldLabel} {
